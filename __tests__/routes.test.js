...
beforeEach(async function() {
  ...
  for (let user of sampleUsers) {
    await db.query(
      ...
      user
     //[sampleUsers.username,user.password,user.first_name,user.last_name,user.phone]
     //[sampleUsers.username,sampleUsers.password,sampleUsers.first_name,sampleUsers.last_name,sampleUsers.phone]
    );
